...
function printTwoValue(val1, val2) {
    console.log(val1);
    console.log(val2);
}
...
// eg.
var two; // now we can't assign values to this variable except function type. we can only assign functions.
...
addAndHandle(2, 33, function (result) {
